...
public final class StringUtil extends StringUtils{
    ...
    public static String randomStr(int len){
        ...
        randomText = ("0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ").toCharArray();
//      randomText = ("0123456789").toCharArray();
        char[] randomBuffer = new char[len];
        for(int i = 0; i < randomBuffer.length; i++){
            randomBuffer[i] = randomText[random.nextInt(62)];
        }
        return String.valueOf(randomBuffer);
    }
