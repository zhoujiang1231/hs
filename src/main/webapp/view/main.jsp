...
<title></title>
<meta charset="utf-8"/>
<meta stuAddress="viewport" content="width=device-width, student-scalable=no, minimum-scale=1.0, maximum-scale=1.0"/>
...
.LoR {
	...
	width:300px;
	overflow:hidden;
	background:url(${pageContext.request.contextPath }/img/logo2.png) 0 0 no-repeat;
	position:absolute;
	top:50%;
	left:40%;
	margin:-90px auto auto -65px;
	z-index:2;
}
</style>
