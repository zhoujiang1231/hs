                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        $.each(list,function (i,teacher) {
                            ...
                            $("#pages").text("<span>第      ${teacher_page.pageNum} 页</span>   +
                                <a href='javaScript:initList(${teacher_page.firstPage})'>首页</a>
                                <a href='javaScript:initList(${teacher_page.prePage})'>上一页</a>
                                <%--<a href='javaScript:initList(${teacher_page.pageNum})' class='current_page' ></a>--%>
                                <a href='javaScript:initList(${teacher_page.lastPage})'>尾页</a>
                                <a href='javaScript:initList(${teacher_page.nextPage})'">下一页</a> " +
                            "<span>共       ${teacher_page.total} 条记录</span>");
                        })
                    }
                })
            }
     ...
     <div style="height:20px"></div>
        ...
        <div id="main1">
            <form id="serachForm">
                ...
                <div id="pages">
                    <span>第      ${teacher_page.pageNum} 页</span>
          	        	<a href="javaScript:initList(${teacher_page.firstPage})">首页</a>
        	        	<a href="javaScript:initList(${teacher_page.prePage})">上一页</a>
                    	<%--<a href="javaScript:initList(${teacher_page.pageNum})"  class="current_page" ></a>--%>
                    <a href="javaScript:initList(${teacher_page.lastPage})">尾页</a>
