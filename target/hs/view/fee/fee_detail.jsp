...
<head> 
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/css/cycss/style.css" />
  <script type='text/javascript' src='${pageContext.request.contextPath}/js/cyjs/jquery.particleground.min.js'></script>
  <script type='text/javascript' src='${pageContext.request.contextPath}/js/cyjs/demo.js'></script>
  <style type="text/css">
  	body{
       	overflow:-Scroll;
       	overflow-x:hidden;
	        	...
	        	<fieldset>
	        		...
	        		<div class="form-group">
	                 ...
	                 <div class="form-group">
	                     ...
	                     <div class="col-xs-4">
	                         <input type="text" class="form-control" id="useridentify" name="fee_name" value="${fee.fee_name}" disabled="disabled"/>
	                     </div>
	                 </div>
				...
				<div class="form-group" style="line-height：3">
	                     ...
	                     <div class="col-xs-4">
	                   		<label class="radio-inline">
								<input type="radio" name="fee_type" id="monthly" value="1" disabled="disabled" 
								 	<c:if test="${fee.fee_type==1}">checked</c:if>
								/> 包月
							</label>
							<label class="radio-inline">
								<input type="radio" name="fee_type" id="package"  value="2" disabled="disabled" 
									 <c:if test="${fee.fee_type==2}">checked</c:if>
								/> 套餐
							</label>
							<label class="radio-inline">
								<input type="radio" name="fee_type" id="timeBased"  value="3" disabled="disabled" 
	                 ...
	                 <div class="form-group" id="ftime">
	                     ...
	                     <div class="input-group">
	                         <input type="text" class="form-control" name="time" value="${fee.fee_time}" disabled="disabled"/>
	                 ...
	                 <div class="form-group" id="fcost">
	                     ...
	                     <div class="col-xs-4">
	                     	<div class="input-group">
	                         	<input type="text" class="form-control" name="basecost" value="${fee.fee_basecost}" disabled="disabled"/>
	                 ...
	                 <div class="form-group" id="funitcost">
	                     ...
	                     <div class="col-xs-4 ">
	                     	<div class="input-group">
	                         	<input type="text" class="form-control" name="unitcost" value="${fee.fee_unitcost}" disabled="disabled"/>
	                 ...
	                 <div class="form-group">
	                     ...
	                     <div class="col-xs-4">
	                         <input type="text" class="form-control" id="useridentify" name="fee_startdate" value="<fmt:formatDate value="${fee.fee_startdate}" pattern="yyyy/MM/dd HH:mm:ss"/>" disabled="disabled"/>
	                     </div>
	                 </div>
	                 ...
	                 <div class="form-group">
	                     ...
	                     <div class="col-xs-4">
	                         <input type="text" class="form-control" id="useridentify" name="fee_date" disabled="disabled" value="<fmt:formatDate value="${fee.fee_date}" pattern="yyyy/MM/dd hh:mm:ss"/>"/>
	                     </div>
	                 </div>
